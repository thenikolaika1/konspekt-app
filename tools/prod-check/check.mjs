...
const files = ["", "index.html", "service-worker.js", "styles.css?v=23", "styles.css", "app.js?v=23", "app.js",
  "js/classic-renderer.js?v=23", "js/classic-renderer.js", "js/mock-content.js?v=23", "js/store.js?v=23", "assets/thumbs/leaf.svg"];
const markers = { "": ["v=23", "v=22"], "index.html": ["v=23", "v=22"], "service-worker.js": ["konspekt-v23", "konspekt-v22"],
  "styles.css?v=23": ["CLASSIC NOTE", "COLOR & DEPTH", "обложки конспектов"], "styles.css": ["CLASSIC NOTE"],
  "app.js?v=23": ["noteThumb", "inNoteSearch"], "app.js": ["noteThumb", "inNoteSearch"],
  "js/classic-renderer.js?v=23": ["cn-intro", "section-bar"], "js/classic-renderer.js": ["cn-intro", "section-bar"],
  "js/mock-content.js?v=23": ["assets/thumbs"], "js/store.js?v=23": ["migrateThumbnails"] };
say("=== HTTP ===");
